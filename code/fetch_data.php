    ...
    while($result = mysqli_fetch_assoc($test)):
        ...
        <div class="col-12 col-sm-6 col-md-6 col-lg-4 col-xl-4">
                        <div class="colum"> 
                            ...
                            <div class="images" style="background-image: url(../admin/items/covers/'. $result['images'] .')"> </div>
                            <div class="details">
                                <br>
                                <h5>'. $result['series'] .'</h5>
                                <h4>'. $result['price'] .'</h4>
                                <p>
                                    <img src="../admin/items/covers/dds__processor.svg" class="icon"> '. $result['processor'] .' '. $result['processor_generation'] .'<br>
                                    <img src="../admin/items/covers/dds__disc-system.svg" class="icon"> '. $result['window'] .'<br>
                                    <img src="../admin/items/covers/dds__video-card.svg" class="icon">'. $result['graphic_card'] .' '. $result['resolution'] .'<br>
                                    <img src="../admin/items/covers/dds__memory.svg" class="icon"> '. $result['ram_size'] .' '. $result['ram_tech'] .' '. $result['ram_speed'] .'<br>
                                    <img src="../admin/items/covers/dds__hard-drive.svg" class="icon"> '. $result['storage_full_info'] .'<br>
                                    <img src="../admin/items/covers/dds__display.svg" class="icon"> '. $result['screen_size'] .' display<br>
                                    <img src="../admin/items/covers/dds__weight.svg" class="icon"> '. $result['weight'] .'<br>
